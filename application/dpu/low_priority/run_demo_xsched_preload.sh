...
# If you run this script directly (without run_with_xsched.sh),
# enable a default "gate" so the queue periodically drains and becomes idle.
# This avoids the queue staying RDY forever and looking "blocked" under HPF.
